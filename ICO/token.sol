...
contract SungJooToken is ERC20Interface, OwnerHelper // SimpleToken이 ERC20Interface 및 OwnerHelper를 상속하여 ERC20Interface 및 OwnerHelper 함수를 사용가능하게 함
                                                     // SungJooToken 하나의 컨트랙트 구성, 밑에 컨트랙트 내에서 사용할 변수에 대해서 이름을 선언 
{
    ...
    function SungJooToken () public // function은 컨트랙트 내에서 사용되는 함수이며 생성자는 생성과 동시에 바로 실행
    {
        name = "SungJooToken"; // 토큰의 이름 SungJooToken
        decimals = 18; // 토큰의 소숫점 아래 자리 수는 18자리
        symbol = "SJT"; // 토큰 이름의 줄임말은 SJT
